 ...
 *
 * `proxy.ts`'s matcher already covers `/admin/:path*` and its comment already claimed this redirect
 ...
 * anything. The proxy has already turned a signed-out caller away at both paths.
 */
