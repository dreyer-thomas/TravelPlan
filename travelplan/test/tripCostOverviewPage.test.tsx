...
// This shell previously painted itself #2f343d, the same non-token dark slate Story 7.9 removed from
// the two map pages, inverting the app's value scheme on the way into this screen.
describe("trip cost overview page shell", () => {
  it("carries no hardcoded colour", () => {
    expectNoHardcodedColour("src/app/(routes)/trips/[id]/costs/page.tsx");
  });
});
